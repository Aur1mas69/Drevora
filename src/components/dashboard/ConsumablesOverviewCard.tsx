  ...
  return (
    <div className="mb-3 grid grid-cols-2 gap-2 sm:grid-cols-3 xl:grid-cols-5">
      {items.map((item) => (
        <div
          key={item.label}
          className="rounded-lg border border-[#CFE3F5] bg-[#F8FBFF]/80 px-2 py-1.5 text-center"
        >
...
function ConsumableTypeTile({
  ...
  return (
    <div className="rounded-xl border border-[#CFE3F5] bg-[#F8FBFF]/90 px-2.5 py-2.5 text-center transition-colors hover:border-[#CFE3F5] hover:bg-[#DCEEFF]/70">
    ...
    <section className={`${dashboardOverviewCardClass} p-4`}>
      <div className="mb-3 flex items-start justify-between gap-2">
        <div className="flex min-w-0 items-start gap-2.5">
          <div className="flex size-9 shrink-0 items-center justify-center rounded-xl border border-[#CFE3F5] bg-[#DCEEFF] text-[#3B82F6]">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-0.5 text-xs text-[#5D7C9D]">Current month usage</p>
          </div>
        </div>
        <Link to="/consumables" className="shrink-0 text-xs font-semibold text-[#3B82F6] hover:underline">
          View
        </Link>
      </div>
      ...
      {typeTiles.length === 0 ? (
        <div className="rounded-xl border border-dashed border-[#CFE3F5] bg-[#F8FBFF]/80 px-3 py-6 text-center">
