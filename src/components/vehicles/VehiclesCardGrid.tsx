...
import { VehicleAvailableSlotCard } from '@/components/vehicles/VehicleAvailableSlotCard'
import { VehicleCard } from '@/components/vehicles/VehicleCard'
import type { VehicleSlotItem } from '@/lib/vehiclePlanSlots'
...
export function VehiclesCardGrid({
  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-1 gap-2.5 min-[400px]:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6">
        {items.map((item) =>
          item.kind === 'vehicle' ? (
            <VehicleCard
              key={item.key}
...
export function VehiclesCardGridSkeleton() {
  return (
    <div className="grid grid-cols-1 gap-2.5 min-[400px]:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6">
