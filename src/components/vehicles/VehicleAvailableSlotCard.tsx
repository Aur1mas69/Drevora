...
type VehicleAvailableSlotCardProps = {
  onAddVehicle: () => void
  slotNumber?: number
}

export function VehicleAvailableSlotCard({
  onAddVehicle,
  slotNumber,
}: VehicleAvailableSlotCardProps) {
  const label =
    slotNumber != null
      ? `Available Vehicle slot ${slotNumber}. Add Vehicle`
      : 'Available Vehicle slot. Add Vehicle'
