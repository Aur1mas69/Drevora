...
> **DRAFT - LEGAL REVIEW REQUIRED.** These Terms are prepared for DREVORA's UK business-to-business SaaS model. They must be reviewed by a solicitor experienced in UK technology, data protection and commercial contracts before first live customer use.
...
4.4 The Service does not replace the Customer's legal, employment, tax, payroll, working-time, roadworthiness, DVSA, DVLA, health and safety, data-protection, record-retention or regulatory obligations.
...
11.3 Unless cancelled, a recurring subscription renews automatically using the payment method connected to the account.

11.4 Payments may be processed by Stripe or another identified payment provider. DREVORA does not store complete payment card numbers.
...
13.1 The Customer may cancel a monthly subscription at any time. Cancellation stops the next renewal.

13.2 Access normally continues until the end of the paid billing period.
...
14.1 If payment fails, DREVORA may retry payment, notify the Customer, request another payment method, restrict functionality, suspend access or prevent a new billing period from starting.

14.2 The Customer remains responsible for properly due unpaid fees, VAT and other applicable taxes.
...
| Minimum archived Worker or Vehicle profile needed to preserve historical links | Up to 6 years after archive |
| Support requests | Normally up to 24 months after closure, longer where required for security or legal claims |
| Security, audit and technical logs | The shortest period reasonably necessary; normally up to 12 months where controlled by DREVORA |
...
20.2 Providers may include Supabase, Vercel, Stripe, Resend and Cloudflare where the relevant service is actively enabled.
...
25.3 After paid access ends, DREVORA may provide a limited final export period where technically and operationally available.
